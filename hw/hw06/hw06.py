...
class VendingMachine:
    ...
    def restock(self, num):
        self.stock = num
        return 'Current ' + self.name + ' stock: ' + str(num)
    ...
    def vend(self):
        if self.stock == 0:
            ...
            if self.balance > self.price:
                result = 'Here is your '+ self.name + ' and $' + str(self.balance - self.price) + ' change.'
                self.balance = 0
                self.stock -= 1     
                return result          
            elif self.balance == self.price:
                result = 'Here is your '+ self.name +'.'
                self.balance = 0
                self.stock -= 1
                return result
            elif self.balance < self.price:
...
class MissManners:
    ...
    'Current balance: $10'
    """
    def __init__(self, unmannered):
        self.unmannered = unmannered
    ...
    def ask(self, sentence, *args):
        if sentence[:6] != 'please':
            ...
            if hasattr(self.unmannered, sentence[7:]):
                return getattr(self.unmannered, sentence[7:])(*args)
            else:
                return 'Thanks for asking, but I know not how to ' + sentence[7:] +'.'
